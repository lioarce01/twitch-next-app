...
const Account = () => {
  ...
  return (
    <div className="pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4">
      ...
      <button
        className="flex items-center justify-center p-3 bg-gray-600 border border-gray-600 my-2 hover:bg-gray-900 duration-200"
        onClick={() => signIn()}
      >
      ...
      <button
        className="flex items-center justify-center p-3 bg-blue-600 border border-blue-600 my-2 hover:bg-blue-900 duration-200"
        onClick={() => signIn()}
      >
